...
export const TICKETS_FIELDS_ERROR_RESET = `${TICKETS}${FIELDS_ERROR} ${RESET}`;
export const TICKETS_FIELDS_ERROR_UPDATE = `${TICKETS}${FIELDS_ERROR} ${UPDATE}`;
...
export const TICKETS_REFRESH = `${TICKETS} ${REFRESH}`;
